...
![](/assets/how/language/javase/oo/1.gif)

### 实现

![](/assets/how/language/javase/oo/2.gif)

### 组合

在逻辑上A是B的“一部分”（a part of），需要用A和其它东西组合出B。A和B不可分,比如人和大脑

![](/assets/how/language/javase/oo/3.gif)

### 聚合

A和B可分.比如电脑和CPU

![](/assets/how/language/javase/oo/4.gif)

### 关联

是一种拥有的关系,它使一个类知道另一个类的属性和方法

![](/assets/how/language/javase/oo/5.gif)

### 依赖

一个类依赖于另一个类的定义.比如方法参数,局部变量,静态方法调用.

![](/assets/how/language/javase/oo/6.gif)
...
![](/assets/how/language/javase/oo/ref.png)
...
![](/assets/how/language/javase/oo/ref2.png)
